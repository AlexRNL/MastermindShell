...
//Fonction qui d�termine un code secret al�atoire (1..9) :
...
//Fonction qui d�termine le nombre de chiffres bien plac�s :
...
//Fonction qui d�termine le nombre de chiffres mal plac�s :
